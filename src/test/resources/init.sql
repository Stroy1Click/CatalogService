...
-- ---------- Products ----------
-- Test: ProductControllerIT get()
-- Описание: продукт для проверки получения по id
INSERT INTO catalog.products (id,category_id, subcategory_id, product_type_id, title, description, price, unit, in_stock)
VALUES (1,1,1, 1, 'First Product', 'Description of first product', 100.00, 'KG', true);

-- Test: ProductControllerIT update()
-- Описание: продукт для проверки метода обновления
INSERT INTO catalog.products (id,category_id, subcategory_id, product_type_id, title, description, price, unit, in_stock)
VALUES (2, 1,1, 1, 'Second Product', 'Description of second product', 150.00,'KG' ,true);

-- Test: ProductControllerIT delete()
-- Описание: продукт для проверки метода удаления
INSERT INTO catalog.products (id,category_id, subcategory_id, product_type_id, title, description, price, unit, in_stock)
VALUES (3, 1,1, 1, 'Third Product', 'Description of third product', 200.00, 'KG', true);
